...
export default function DLE70HDPage() {
  ...
  // 发动机参数
  const engineParams = [
    { name: '类型', value: '水平对置双缸水冷' },
    { name: '排量', value: '70cm³' },
    { name: '缸径×行程', value: '38.5mm×30mm' },
    { name: '功率', value: '7HP/8200转 功率:4.2KW(0 海拔)' },
    { name: '怠速', value: '5000-6000转' },
    { name: '发动机重量', value: '4.8KG' },
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto text-center">
                    DLE70HD是一款先进的油电混动发动机，采用水平对置双缸水冷设计，提供高效稳定的动力输出。
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                  <div className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-2xl border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                    ...
                    <p className="text-sm text-gray-400 text-center">7HP/8200转，4.2KW功率输出</p>
                  </div>
                  <div className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-2xl border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                  ...
                  <div className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-2xl border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2 text-center">双缸设计</h3>
                    <p className="text-sm text-gray-400 text-center">水平对置双缸，动力更均衡</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="downloads" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/50 border-t border-gray-800">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400">获取DLE70HD的详细安装说明和3D模型数据</p>
            </div>
