...
export default function DLE70HDEnglishPage() {
  const [activeImage, setActiveImage] = useState(0);

  // Product images
  const images = [
    '/images/hevengine/DLE70HD/DLE70HDZT1.jpg',
    '/images/hevengine/DLE70HD/DLE70HDZT2.jpg',
    '/images/hevengine/DLE70HD/DLE70HDZT3.jpg'
  ];
  ...
  const accessories = [
    {
      ...
      image: '/images/hevengine/DLE70HD/DLE70HDFJ1.jpg'
    },
    {
      title: 'Engine Radiator',
      image: '/images/hevengine/DLE70HD/DLE70HDFJ2.jpg'
    },
    {
      title: 'Food Grade Silicone Braided Tube Enhanced Steam Explosion-Proof Hose',
      image: '/images/hevengine/DLE70HD/DLE70HDFJ3.jpg'
    },
    {
      title: 'Throttle Controller',
      image: '/images/hevengine/DLE70HD/DLE70HDFJ4.jpg'
    },
    {
      title: 'Complete Engine Kit',
      image: '/images/hevengine/DLE70HD/DLE70HDFJ5.jpg'
    },
    {
      title: 'Starter',
      image: '/images/hevengine/DLE70HD/DLE70HDFJ6.jpg'
    }
  ];

  // Dimension image
  const dimensionImage = '/images/hevengine/DLE70HD/DLE70HDcc1.jpg';
  ...
  const engineParams = [
    ...
    { name: 'Displacement', value: '70cm³' },
    { name: 'Bore × Stroke', value: '38.5mm × 30mm' },
    { name: 'Power', value: '7HP/8200 rpm Power: 4.2KW (0 altitude)' },
    { name: 'Idle Speed', value: '5000-6000 rpm' },
    { name: 'Engine Weight', value: '4.8KG' },
      ...
      <div className="sticky top-14 z-40 w-full bg-black/90 backdrop-blur-xl border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center text-sm font-medium">
            <span className="text-2xl font-bold text-white tracking-tight bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">DLE70HD</span>
                ...
                <div className="relative aspect-[16/9] overflow-hidden">
                  {images.map((src, index) => (
                    ...
                    >
                      <Image
                        src={src}
                        alt={`DLE70HD Product Image ${index + 1}`}
                        fill
                        sizes="100vw"
              ...
              <div className="space-y-8">
                <div>
                  <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-4 text-center">
                    <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">DLE70HD</span>
                    <br />
                  ...
                  <p className="text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto text-center">
                    The DLE70HD is an advanced hybrid electric engine with a horizontally opposed twin-cylinder water-cooled design,
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                  <div className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-2xl border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                    ...
                    <p className="text-sm text-gray-400 text-center">7HP/8200 rpm, 4.2KW power output</p>
                  </div>
                  <div className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-2xl border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
        ...
        <section id="downloads" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/50 border-t border-gray-800">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400">Access detailed installation instructions and 3D model data for DLE70HD</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <a 
                href="https://cdn.dlengine.com/pdf/DLE70HDCN.pdf" 
                target="_blank" 
              ...
              <a 
                href="https://cdn.dlengine.com/3D/ZIP/DLE70HD.zip" 
                className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-800 to-gray-900 p-8 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10"
              >
