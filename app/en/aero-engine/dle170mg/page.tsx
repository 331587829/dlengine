...
export default function DLE170MGPage() {
  const [isGeneratorVersion, setIsGeneratorVersion] = useState(false);
  const [activeImage, setActiveImage] = useState(0);

  // Switch images based on version - DLE170MG
  // Standard Electric Start: DLE170MZT1.jpg, DLE170MZT2.jpg
  // Electric Start Generator: DLE170MGZT1.jpg, DLE170MGZT2.jpg (mg means generator version)
  const images = isGeneratorVersion 
    ? [
        '/images/aero-engine/dle170mg/DLE170MGZT1.jpg',
        '/images/aero-engine/dle170mg/DLE170MGZT2.jpg'
      ]
    : [
        '/images/aero-engine/dle170mg/DLE170MZT1.jpg',
        '/images/aero-engine/dle170mg/DLE170MZT2.jpg'
      ];

  // Dimension images
  const dimensionImages = isGeneratorVersion 
    ? ['/images/aero-engine/dle170mg/DLE170MGcc1.jpg']
    : ['/images/aero-engine/dle170mg/DLE170Mcc1.jpg'];
  ...
  // Weight distribution - Standard version (Engine + Exhaust 5900g)
  const standardWeight = [
    { component: 'Engine + Exhaust', weight: '5900g' },
      ...
      <div className="sticky top-14 z-40 w-full bg-black/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-12 items-center text-sm font-medium">
            <span className="text-xl font-bold text-white tracking-tight">DLE170M</span>
      ...
      <main>
        ...
        <section id="overview" className="relative pt-32 pb-10 flex flex-col items-center text-center px-4">
          ...
          <div className="mb-12 flex items-center gap-4 bg-white/10 backdrop-blur-md px-6 py-3 rounded-full border border-white/20">
            <span className={`text-sm font-medium transition ${!isGeneratorVersion ? 'text-white font-semibold' : 'text-gray-400'}`}>DLE170M Electric Start</span>
            <button
            ...
            <span className={`text-sm font-medium transition ${isGeneratorVersion ? 'text-white font-semibold' : 'text-gray-400'}`}>DLE170MG Electric Start Generator</span>
          </div>
          ...
          <div className="w-full max-w-[1400px] mx-auto select-none">
            ...
            <div className="relative rounded-3xl bg-[#050505] border border-white/10 shadow-2xl overflow-hidden aspect-[16/9] mb-8 group">
              ...
              {images.map((src, index) => (
                <Image
                  key={`${src}-${isGeneratorVersion ? 'mg' : 'm'}`}
                  src={src}
                  alt={`DLE170MG ${isGeneratorVersion ? 'Electric Start Generator' : 'Electric Start'} ${index + 1}`}
                  fill
        ...
        <section id="specs" className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">Explore the detailed performance metrics of the DLE170MG</p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8">
            {dimensionImages.map((src, index) => (
              <div key={index} className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
                <Image 
                  src={src} 
                  alt={`DLE170MG ${isGeneratorVersion ? 'Electric Start Generator' : 'Electric Start'} Dimension Diagram`} 
                  width={1200}
                  height={800}
        ...
        <section id="downloads" className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">Download detailed installation instructions and 3D model data for the DLE170MG.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <a 
                href="https://cdn.dlengine.com/pdf/DLE170MGmanual.pdf" 
                target="_blank" 
              ...
              <a 
                href="https://cdn.dlengine.com/3D/ZIP/DLE170MG.zip" 
                className="flex items-center justify-between bg-[#111111]/60 backdrop-blur-lg hover:bg-gray-800/60 border border-white/10 p-8 rounded-3xl transition duration-300 group"
              >
                <div className="flex items-center gap-6">
