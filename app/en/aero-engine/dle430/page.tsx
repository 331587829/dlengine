...
export default function DLE430Page() {
  ...
  const technicalParams = [
    { name: 'Bore', value: '70mm' },
    { name: 'Stroke', value: '56mm' },
    { name: 'Displacement', value: '430.8cc' },
    { name: 'Compression Ratio', value: 'Theoretical 11∶1, Actual 6.5∶1' },
    { name: 'Reduction Ratio', value: '2.55' },
    { name: 'Power', value: '42HP at 6800 RPM' },
    { name: 'Static Thrust', value: '110kg' },
    { name: 'Max RPM', value: '7000 RPM' },
    { name: 'Idle RPM', value: '1000 RPM' },
    { name: 'Spark Plug', value: '14mm DLE-8' },
    { name: 'Spark Plug Gap', value: '0.6MM' },
    { name: 'Carburetor', value: 'DLE Self-priming' },
    { name: 'Fuel', value: 'Gasoline 93#, 97#' },
    { name: 'Fuel Mixed Oil', value: '2T FD Grade, Fully Synthetic' },
    { name: 'Oil Mixing Ratio', value: '50 : 1' },
    { name: 'Transmission Oil', value: 'Gear Oil, 85W-140EP API-GL5 GL6 SAE 140 EP' },
    { name: 'Ignition System', value: 'Dual DC Capacitor Discharge Ignition, 12V Power Supply, 5W/each' },
    { name: 'Generator Power', value: 'Permanent Magnet Generator 14.5V, 90W' },
    { name: 'Starter Motor Current', value: '35A' },
    { name: 'Rotation Direction', value: 'Clockwise (Facing Propeller)' },
    { name: 'Cooling', value: 'Fan Cooling' },
    { name: 'Weight', value: 'Engine: 27kg, Exhaust Pipe: 4.1kg, Total Weight: 32.25 kg' },
    { name: 'Recommended Propeller', value: '1.5M Variable Pitch Carbon Fiber Propeller' },
  ];
      ...
      <main>
        ...
        <section id="overview" className="relative w-full h-screen flex flex-col items-center justify-start pt-32 md:pt-40 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="DLE430 Twin-Cylinder Inline Two-Stroke Engine"
              fill
              sizes="100vw"
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 font-medium mb-8 drop-shadow-md max-w-3xl leading-relaxed">
              DL430 Twin-Cylinder Inline Two-Stroke Engine can be used for UAVs, ultra-light experimental aircraft, etc.
            </p>
          </div>
        </section>
              ...
              <div className="relative rounded-3xl bg-[#050505] border border-white/10 shadow-2xl overflow-hidden aspect-[16/9] mb-8 group">
                ...
                {images.map((src, index) => (
                  <Image
                    key={src}
                    src={src}
                    alt={`DLE430 Product Image ${index + 1}`}
                    fill
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-white/10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">Precise engineering diagrams for installation planning. Click to enlarge</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {dimensionImages.map((src, index) => (
              ...
              >
                <Image 
                  src={src} 
                  alt={`DLE430 Dimension Diagram ${index + 1}`} 
                  width={1200}
                  height={800}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm" onClick={closeModal}>
            <div className="relative max-w-7xl w-full max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="relative w-full h-[90vh] rounded-lg overflow-hidden bg-gray-900 flex items-center justify-center">
                <Image
                  src={selectedImage}
                  alt={`DLE430 Dimension Diagram ${selectedImageIndex + 1}`}
                  width={1200}
                  height={800}
        ...
        <section id="downloads" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg">Download detailed installation instructions and 3D model data for the DLE430.</p>
            </div>
