...
export default function DLE120T4Page() {
  const [activeImage, setActiveImage] = useState(0);
  const images = [
    '/images/rcengine/DLE120T4/DLE120T4ZT1.jpg',
    '/images/rcengine/DLE120T4/DLE120T4ZT2.jpg',
    '/images/rcengine/DLE120T4/DLE120T4ZT3.jpg'
  ];
      ...
      <div className="sticky top-14 z-40 w-full bg-black/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-12 md:h-12 items-center text-xs md:text-sm font-medium">
            <span className="text-lg md:text-xl font-bold text-white tracking-tight shrink-0">DLE120T4</span>
      ...
      <main>
        ...
        <section id="overview" className="relative pt-32 pb-10 flex flex-col items-center text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-400 font-medium mb-12 max-w-2xl">
            Powerful Performance, Professional Quality. Engineered for High-End Flight Applications.
          </p>
          ...
          <div className="w-full max-w-[1400px] mx-auto select-none">
            ...
            <div className="relative rounded-3xl bg-[#050505] border border-white/10 shadow-2xl overflow-hidden aspect-[16/9] mb-8 group">
              ...
              {/* Modern Thumbnail Navigation (PC: Absolute Bottom Left, Mobile: Bottom) */}
            ...
            {/* Mobile Thumbnail Navigation (Only Shows on Small Screens) */}
        ...
        <section id="specs" className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">Explore the detailed performance metrics of the DLE120T4</p>
            </div>
                ...
                <div className="p-8 md:p-14 hover:bg-white/[0.02] transition-colors duration-500">
                  ...
                  <dl className="space-y-6">
                    ...
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right">1200 rmp</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                    ...
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors">Recommended Propeller</dt>
                      <dd className="text-white font-medium text-right">27x10 ; 26x12 ; 28x10</dd>
                    </div>
                    <div className="flex justify-between pt-2 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors">Recommended Spark Plug</dt>
                ...
                <div className="p-8 md:p-14 hover:bg-white/[0.02] transition-colors duration-500">
                  ...
                  <dl className="space-y-6">
                    ...
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right">7.1 : 1</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                    ...
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right space-y-1">
                        ...
                        <div className="flex justify-end items-center gap-2"><span className="text-gray-500 text-sm">Exhaust</span> 500g</div>
        ...
        {/* Dimensions Full Width Display Area */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-white/10">
          ...
          <div className="grid grid-cols-1 gap-8">
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE120T4/DLE120T4cc1.jpg" 
                alt="DLE120T4 Dimensions" 
                width={1200}
                height={800}
        ...
        <section id="downloads" className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">Access detailed installation instructions and 3D model data for the DLE120T4.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <a 
                href="https://cdn.dlengine.com/pdf/DLE120-T4%20USER%20MANUAL.pdf" 
                target="_blank" 
              ...
              <a 
                href="https://cdn.dlengine.com/3D/ZIP/DLE120T4.zip" 
                className="flex items-center justify-between bg-[#111111] hover:bg-gray-800 border border-white/10 p-8 rounded-3xl transition duration-300 group"
              >
                <div className="flex items-center gap-6">
