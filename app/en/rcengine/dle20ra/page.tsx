...
export default function DLE20RAPage() {
  const [activeImage, setActiveImage] = useState(0);
  const images = [
    '/images/rcengine/DLE20RA/DLE20RAZT1.jpg',
    '/images/rcengine/DLE20RA/DLE20RAZT2.jpg',
    '/images/rcengine/DLE20RA/DLE20RAZT3.jpg'
  ];
    ...
    <div className="min-h-screen bg-black font-sans text-white">
      ...
      <div className="sticky top-14 z-40 w-full bg-black/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-12 md:h-12 items-center text-xs md:text-sm font-medium">
            <span className="text-lg md:text-xl font-bold text-white tracking-tight shrink-0">DLE20RA</span>
            <div className="flex space-x-3 md:space-x-6 text-gray-400 overflow-x-auto whitespace-nowrap no-scrollbar ml-4">
              <a href="#overview" className="hover:text-white transition py-2">Overview</a>
              <a href="#specs" className="hover:text-white transition py-2">Specs</a>
              <a href="#downloads" className="hover:text-white transition py-2">Downloads</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <main>
        {/* Header Hero Section: Large Image Carousel with Thumbnails */}
        <section id="overview" className="relative pt-32 pb-10 flex flex-col items-center text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-400 font-medium mb-12 max-w-2xl">
            Compact Size, Powerful Performance. Engineered for Ultimate Flight.
          </p>
          
          <div className="w-full max-w-[1400px] mx-auto select-none">
            {/* Core Product Image Carousel Display Area (Modern Rebuild) */}
            <div className="relative rounded-3xl bg-[#050505] border border-white/10 shadow-2xl overflow-hidden aspect-[16/9] mb-8 group">
              ...
              {/* Bottom-left Thumbnail Navigation (PC absolute positioning, Mobile kept at bottom) */}
            ...
            {/* Mobile Thumbnail Navigation (Only visible on small screens) */}
        ...
        <section id="specs" className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">Detailed performance metrics of DLE20RA</p>
            </div>
                ...
                <div className="p-8 md:p-14 hover:bg-white/[0.02] transition-colors duration-500">
                  ...
                  <dl className="space-y-6">
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right">2.5HP/9000rpm</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors">Idle Speed</dt>
                      <dd className="text-white font-medium text-right">1750 rmp</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors">Thrust (100m alt)</dt>
                      <dd className="text-white font-medium text-right">6.3kg</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors">Thrust (1800m alt)</dt>
                      <dd className="text-white font-medium text-right">5.6kg</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors">Propeller Sizes</dt>
                      <dd className="text-white font-medium text-right">14x10 ; 15x8 ; 16x6 ; 17x6</dd>
                    </div>
                ...
                <div className="p-8 md:p-14 hover:bg-white/[0.02] transition-colors duration-500">
                  ...
                  <dl className="space-y-6">
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right">20cm³</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors">Bore × Stroke</dt>
                      <dd className="text-white font-medium text-right">32mm × 25mm</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                    ...
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors mt-1">Weight Dist.</dt>
                      <dd className="text-white font-medium text-right space-y-1">
                        <div className="flex justify-end items-center gap-2"><span className="text-gray-500 text-sm">Main Engine</span> 660g</div>
                        <div className="flex justify-end items-center gap-2"><span className="text-gray-500 text-sm">Exhaust</span> 80g</div>
                        <div className="flex justify-end items-center gap-2"><span className="text-gray-500 text-sm">Ignition</span> 140g</div>
                      </dd>
                    </div>
                    <div className="flex justify-between pt-2 group">
        ...
        {/* Dimensions Gallery Section (Sync with Chinese Version) */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-white/10">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Precise engineering dimensions for your cabin layout planning.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE20RA/DLE20RAcc1.jpg" 
                alt="DLE20RA Dimensions 1" 
                width={1200}
                height={800}
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE20RA/DLE20RAcc2.jpg" 
                alt="DLE20RA Dimensions 2" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE20RA/DLE20RAcc3.jpg" 
                alt="DLE20RA Dimensions 3" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE20RA/DLE20RAcc4.jpg" 
                alt="DLE20RA Dimensions 4" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
        ...
        <section id="downloads" className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-4">Downloads</h2>
              <p className="text-gray-400 text-lg">Get detailed installation instructions and 3D model data for your DLE20RA.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <a 
                href="https://cdn.dlengine.com/pdf/DLE20RA%20USER%20MANUAL.pdf" 
                target="_blank" 
              ...
              <a 
                href="https://cdn.dlengine.com/3D/ZIP/DLE20RA.zip" 
                className="flex items-center justify-between bg-[#111111] hover:bg-gray-800 border border-white/10 p-8 rounded-3xl transition duration-300 group"
              >
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-white group-hover:text-blue-400 transition mb-1">3D CAD Model</h4>
