...
export default function DLE20Page() {
  const [activeImage, setActiveImage] = useState(0);
  const images = [
    '/images/rcengine/DLE20/DLE20ZT1.jpg',
    '/images/rcengine/DLE20/DLE20ZT2.jpg',
    '/images/rcengine/DLE20/DLE20ZT3.jpg'
  ];
      ...
      <div className="sticky top-14 z-40 w-full bg-black/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-12 md:h-12 items-center text-xs md:text-sm font-medium">
            <span className="text-lg md:text-xl font-bold text-white tracking-tight shrink-0">DLE20</span>
        ...
        <section id="specs" className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">Detailed performance metrics of DLE20</p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE20/DLE20cc1.jpg" 
                alt="DLE20 Dimensions 1" 
                width={1200}
                height={800}
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE20/DLE20cc2.jpg" 
                alt="DLE20 Dimensions 2" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE20/DLE20cc3.jpg" 
                alt="DLE20 Dimensions 3" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE20/DLE20cc4.jpg" 
                alt="DLE20 Dimensions 4" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
        ...
        <section id="downloads" className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">Get detailed installation instructions and 3D model data for your DLE20.</p>
            </div>
