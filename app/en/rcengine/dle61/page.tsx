...
export default function DLE61Page() {
  const [activeImage, setActiveImage] = useState(0);
  const images = [
    '/images/rcengine/DLE61/DLE61ZT1.jpg',
    '/images/rcengine/DLE61/DLE61ZT2.jpg',
    '/images/rcengine/DLE61/DLE61ZT3.jpg'
  ];
      ...
      <div className="sticky top-14 z-40 w-full bg-black/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-12 items-center text-sm font-medium">
            <span className="text-xl font-bold text-white tracking-tight">DLE61</span>
        ...
        <section id="specs" className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">Detailed performance metrics of the DLE61</p>
            </div>
                ...
                <div className="p-8 md:p-14 hover:bg-white/[0.02] transition-colors duration-500">
                  ...
                  <dl className="space-y-6">
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right">6HP/7500rpm</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                    ...
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right">15kg</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      <dt className="text-gray-400 group-hover:text-gray-300 transition-colors">Thrust (1800m altitude)</dt>
                      <dd className="text-white font-medium text-right">13kg</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                ...
                <div className="p-8 md:p-14 hover:bg-white/[0.02] transition-colors duration-500">
                  ...
                  <dl className="space-y-6">
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right">60cm³</dd>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                    ...
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right space-y-1">
                        <div className="flex justify-end items-center gap-2"><span className="text-gray-500 text-sm">Engine</span> 1370g</div>
                        <div className="flex justify-end items-center gap-2"><span className="text-gray-500 text-sm">Exhaust</span> 150g</div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto border-t border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE61/DLE61cc1.jpg" 
                alt="DLE61 Dimension Diagram 1" 
                width={1200}
                height={800}
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE61/DLE61cc2.jpg" 
                alt="DLE61 Dimension Diagram 2" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE61/DLE61cc3.jpg" 
                alt="DLE61 Dimension Diagram 3" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                src="/images/rcengine/DLE61/DLE61cc4.jpg" 
                alt="DLE61 Dimension Diagram 4" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
        ...
        <section id="downloads" className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <a 
                href="https://cdn.dlengine.com/pdf/DLE61%20USER%20MANUAL.pdf" 
                target="_blank" 
              ...
              <a 
                href="https://cdn.dlengine.com/3D/ZIP/DLE61.zip" 
                className="flex items-center justify-between bg-[#111111] hover:bg-gray-800 border border-white/10 p-8 rounded-3xl transition duration-300 group"
              >
                <div className="flex items-center gap-6">
