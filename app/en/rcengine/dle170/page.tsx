        ...
        <section id="specs" className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">Detailed performance metrics for the DLE170</p>
            </div>
                  ...
                  <dl className="space-y-6">
                    ...
                    <div className="flex justify-between border-b border-white/5 pb-4 group">
                      ...
                      <dd className="text-white font-medium text-right space-y-1">
                        <div className="flex justify-end items-center gap-2"><span className="text-gray-500 text-sm">Engine</span> 3620g</div>
                        <div className="flex justify-end items-center gap-2"><span className="text-gray-500 text-sm">Exhaust</span> 470g</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                ...
                alt="DLE170 Dimension Drawing 1" 
                width={1200}
                height={800}
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                ...
                alt="DLE170 Dimension Drawing 2" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                ...
                alt="DLE170 Dimension Drawing 3" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
            ...
            <div className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
              <Image 
                ...
                alt="DLE170 Dimension Drawing 4" 
                width={1200}
                height={800}
                className="w-full h-auto object-contain transform group-hover:scale-[1.02] transition-transform duration-500"
              />
