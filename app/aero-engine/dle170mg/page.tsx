...
export default function DLE170MGPage() {
  ...
  // 根据版本切换图片 - DLE170MG
  // 普通电启动版: DLE170MZT1.jpg, DLE170MZT2.jpg
  // 电启动发电版: DLE170MGZT1.jpg, DLE170MGZT2.jpg (mg是可以发电的)
  ...
  // 重量分布 - 电启动版 (主机+排气管5900g)
  const standardWeight = [
    { component: '主机+排气管', weight: '5900g' },
      ...
      <main>
        ...
        <section id="overview" className="relative pt-32 pb-10 flex flex-col items-center text-center px-4">
          ...
          <div className="mb-12 flex items-center gap-4 bg-white/10 backdrop-blur-md px-6 py-3 rounded-full border border-white/20">
            <span className={`text-sm font-medium transition ${!isGeneratorVersion ? 'text-white font-semibold' : 'text-gray-400'}`}>DLE170M 电启动版</span>
            <button
            ...
            <span className={`text-sm font-medium transition ${isGeneratorVersion ? 'text-white font-semibold' : 'text-gray-400'}`}>DLE170MG 电启动发电版</span>
          </div>
            ...
            <div className="relative rounded-3xl bg-[#050505] border border-white/10 shadow-2xl overflow-hidden aspect-[16/9] mb-8 group">
              ...
              {images.map((src, index) => (
                <Image
                  ...
                  src={src}
                  alt={`DLE170MG ${isGeneratorVersion ? '电启动发电版' : '电启动版'} ${index + 1}`}
                  fill
        ...
        <section id="specs" className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">探索DLE170MG的详细性能指标</p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8">
            {dimensionImages.map((src, index) => (
              <div key={index} className="bg-gray-900/50 rounded-[2rem] p-6 border border-white/5 group">
                <Image 
                  src={src} 
                  alt={`DLE170MG ${isGeneratorVersion ? '电启动发电版' : '电启动版'} 尺寸图`} 
                  width={1200}
                  height={800}
        ...
        <section id="downloads" className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">获取DLE170MG的详细安装说明和3D模型数据。</p>
            </div>
