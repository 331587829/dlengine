...
export default function DLE55RAPage() {
  ...
  // 确保图片在构建时正确加载
  const imageConfig = {
    unoptimized: true, // 禁用Next.js图片优化，避免构建问题
        ...
        <section id="specs" className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">了解 DLE55RA 的详细性能指标</p>
            </div>
        ...
        <section id="downloads" className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">获取 DLE55RA 的详细安装说明及三维模型数据，助您快速完成部署。</p>
            </div>
